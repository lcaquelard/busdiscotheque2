...
//        $this->bus_types["mini"]->addBus(   'mini bus disco',   'minibusdisco', 9,  3);
        ...
        $this->option_groups['default']->addOption('birthday_kid', 'pack anniversaire enfant', 'À partir de 150€', '1 BOX À BONBON, 3 BOUTEILLES DE CHAMPOMY ET UN <br><br> BUS REMPLI DE BALLONS POUR LE PLUS GRAND <br><br> BONHEUR DE VOS ENFANTS&nbsp;!<br>Classic Bus : 150€  Double Bus 175€');
        $this->option_groups['default']->addOption('birthday_adult', 'pack anniversaire adulte', 'À partir de 175€', '1 BOX À BONBON, 2 BOUTEILLES DE CHAMPAGNE <br><br> NICOLAS FEUILLATE ET UN BUS REMPLI DE BALLONS <br><br> POUR AJOUTER LA TOUCHE FINALE À VOTRE SOIRÉE&nbsp;!<br>Classic Bus : 175€ Double Bus 200€');
...
//        $this->option_groups['default']->addOption('pinata', 'piñata', '150€', 'Vous cherchez à ajouter une touche de joie et de festivités à votre événement&nbsp;?<br>Ne cherchez plus&nbsp;! Découvrez nos piñatas, le moyen idéal pour divertir vos invités et créer des souvenirs inoubliables&nbsp;!');
        ...
        $this->option_groups['default']->addOption('champagne', 'Champagne', '44,90€ / bouteille', 'FAVORI DANS LES GRANDES OCCASIONS ,<br>LE CHAMPAGNE EST UN MUST HAVE DANS NOS BUS.<br>NOUS NOUS OCCUPONS DE VOUS FOURNIR TOUT AU LONG DE LA SOIRÉE GRÂCE À NOTRE CUVÉE PRESTIGE<br>NICOLAS FEUILLATE.');
        $this->option_groups['default']->addOption('wine', 'Vins', '24,90€ / bouteille', 'ROUGE, BLANC OU ROSÉ,<br>IL Y EN A POUR TOUS LES GOÛTS&nbsp;!<br>NOUS VOUS PROPOSONS ÉGALEMENT UNE SÉLECTION<br>DE VINS, POUR ACCOMPAGNER VOS PLATEAUX APÉRITIFS ET COMMENCER LA SOIRÉE TOUT EN DOUCEUR.');
        $this->option_groups['default']->addOption('beer', 'Bière', '3,90€ / bouteille', 'BREVAGE PRÉFÉRÉ DE NOS ÉTUDIANTS,<br>LA BIÈRE FAIT AUSSI TRÈS BIEN L\'AFFAIRE POUR PARTAGER UN DÉBUT DE SOIRÉE À PETIT BUDGET.<br> OUBLIEZ L\'HAPPY HOUR, CHEZ NOUS, C\'EST BIÈRE PAS CHÈRE À VOLONTÉ TOUTE LA SOIRÉE&nbsp;!');
        ...
        $this->option_groups['default']->addOption('cookies', 'COOKIES XXL', 'À partir de 50€', 'Savourez nos cookies géants, fondants et gourmands, parfaits pour ajouter une touche sucrée à votre soirée dansante&nbsp;!<br>20 cookies : 50€  40 cookies : 70€  60 cookies : 110€');
        $this->option_groups['default']->addOption('tiramisu', 'Tiramisu gourmand', '3€', 'Offrez-vous une douceur italienne avec notre tiramisu, parfait pour une touche sucrée et élégante durant votre soirée&nbsp;!');
