...
class DefaultController extends AbstractController
{
    ...
    public function __construct(){
        ...
        $this->option_groups['christmas']->addOption('christmas_headclip', 'Serre-tête de Noël', 'À partir de 90€', 'QU\'EST-CE QUE SERAIT NOËL SANS LES CERFS POUR<br>TIRER LE TRAINEAU ?<br> EQUIPEZ VOS INVITÉS AVEC CET ACCESSOIRE ORIGINAL QUI SAURA RAVIR PETITS ET GRANDS.<br><br><span class="bold">Pack(35): 80€ - Pack(55): 120€ - Pack(70): 160€</span>');
