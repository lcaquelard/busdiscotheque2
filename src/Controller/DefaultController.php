...
class DefaultController extends AbstractController
{
    ...
    public function __construct(){
        ...
        $this->option_groups['default']->addOption('droit_bouchon', 'droit de bouchon', 'gratuit', 'QUE DEMANDER DE PLUS QUAND ON PEUT APPORTER SON PROPRE CUVÉ&nbsp;!<br>VENEZ AVEC VOTRE ALCOOL SANS AUCUN FRAIS SUPPLÉMNTAIRE&nbsp;!');
    }
    /**'
     * @Route("/", name="index")
     * @return Response
