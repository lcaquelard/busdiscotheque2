...
class DefaultController extends AbstractController
{
    ...
    public function __construct(){
        ...
        $this->option_groups['default']->addOption('ballons', 'Votre age en ballon', '300€', 'PERSONNALISEZ VOTRE ÉVÉNEMENT JUSQU\'AU DERNIER DÉTAIL !<br><br>DE VOS 10 ANS À  VOS 100 ANS ANS,&nbsp;AJOUTEZ VOTRE AGE AVEC DEUX BALLONS CHIFFRÉS&nbsp;!');
